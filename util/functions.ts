...
function convertToSql(responseQuery):string {
    ...
    for (var i=0; i < keys.length; i++) {
        let key = keys[i]; let value:string = values[i]; let splitValue:Array<string>
        ...
        let operator:string; let condition:string;
